...
const ViewsDetails = ({ name }: Props) => { 
    return (
        <div className='grid grid-cols-2 gap-3 mt-6 place-items-center'>
            {/* Card 1 */}
     <div className='views-grid space-y-3'>
         <span>
         <p className='font-rota_bold text-[28.17px]'>153</p>
         <p className='font-rota_semibold text-[13.64px] -mt-2'>Viewers watching</p>
         </span>
     ...
     {/* Card 4 */}
     <div className='views-grid'>
         <p className='font-rota_bold text-[28.17px]'>671.5<span className='font-rota_semibold text-[18px]'>hrs</span></p>
